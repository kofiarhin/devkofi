...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `TASK-001` | `P0` | `yes` | `none` | `TASK-003` | `server/data/templates.json`; `server/controllers/templatesController.js`; `server/routes/templateRoutes.js`; `server/app.js`; `server/tests/templates.test.js` | `claimed` | `backend-worker` | `parallel-worker` | `low` | `2026-05-15` | `` | Backend JSON endpoint slice. |
| `TASK-002` | `P0` | `yes` | `none` | `TASK-003` | `client/src/services/templateService.js`; `client/src/hooks/queries/useTemplates.js`; `client/src/Pages/Templates/Templates.jsx` | `claimed` | `frontend-worker` | `parallel-worker` | `low` | `2026-05-15` | `` | Frontend fetch/render slice. |
| `TASK-003` | `P1` | `no` | `TASK-001`, `TASK-002` | `final response` | `_parallel/claims.md`; `_parallel/locks.md`; `_parallel/agent-status.md`; `_progress/progress.md`; `_handoff/current.md`; `_review/2026-05-15-build-templates-data-flow.md`; `_release/build-templates-data-flow.md`; `_summary/2026-05-15-build-templates-data-flow.md` | `claimed` | `orchestrator` | `orchestrator` | `medium` | `2026-05-15` | `` | Final merge review and workflow artifacts after workers complete. |
